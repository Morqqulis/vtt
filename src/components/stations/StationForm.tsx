						...
						<div className='space-y-4'>
							...
							<div>
								...
								<Select value={formData.status || ''} onValueChange={value => handleChange('status', value)}>
									...
									<SelectContent className='bg-[#1a1a1a] border-gray-700'>
										<SelectItem value='active' className='hover:bg-[#282828] text-gray-200'>
											Active
										</SelectItem>
										<SelectItem value='inactive' className='hover:bg-[#282828] text-gray-200'>
											Inactive
										</SelectItem>
										<SelectItem value='maintenance' className='hover:bg-[#282828] text-gray-200'>
											Maintenance
										</SelectItem>
									</SelectContent>
								</Select>
